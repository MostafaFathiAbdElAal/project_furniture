        ...
        <section className="pt-3 sm:pt-7 md:pt-10 pb-5">
            <div className="container space-y-10">
                ...
                <section className="grid grid-cols-12 gap-5 sm:gap-3 px-2 sm:px-0 ">
                    <div tabIndex={2} className="col-span-12 sm:col-span-6 justify-self-center flex flex-col items-center lg:col-span-4 hover:shadow-lg group transition-shadow duration-200 p-10">
                    ...
                    <div tabIndex={2} className="col-span-12 sm:col-span-6  justify-self-center flex flex-col items-center lg:col-span-4 hover:shadow-lg group transition-shadow duration-200 p-10 w-full">
                ...
                <div className="col-span-12 flex justify-center">
                    <a tabIndex={2} href="#footer" className="bg-emerald-700 hover:bg-emerald-800 transition-colors duration-300 ease-in-out text-white py-2 px-4 mt-4  font-cairo font-bold text-lg">معرفة المزيد</a>
                </div>
